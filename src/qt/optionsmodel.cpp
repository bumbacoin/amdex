...
void OptionsModel::Init()
{
    ...
    fUseAmsterdexTheme = settings.value("fUseAmsterdexTheme", true).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case UseAmsterdexTheme:
            return QVariant(fUseAmsterdexTheme);
        default:
            return QVariant();
        }
    }
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case CoinControlFeatures: {
            ...
            break;
        case UseAmsterdexTheme:
            fUseAmsterdexTheme = value.toBool();
            settings.setValue("fUseAmsterdexTheme", fUseAmsterdexTheme);
            break;
        default:
            break;
        }
