...
const string strMessageMagic = "Amsterdex Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees) 
{
    ...
    {
      nSubsidy = 349500 * COIN;
      return nSubsidy + nFees;
    }
    
	else if (pindexBest->nHeight+1 < 6000)
    {
      nSubsidy = 0.001 * COIN;
      return nSubsidy + nFees;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Amsterdex", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "AMDEX Genesis Block - 10th of November 2018";
        CTransaction txNew;
        txNew.nTime = 1541873300;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1541873300;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1189725;
		if(fTestNet)
        {
            block.nNonce   = 0;
        }				
        ...
        assert(block.hashMerkleRoot == uint256("0xcddf3631d7898475d1c826e3013b187554fe0cebe3d66a34e9958adf78c5144d"));        
		block.print();
...
unsigned char pchMessageStart[4] = { 0xc2, 0xb3, 0xc5, 0xa3 };
